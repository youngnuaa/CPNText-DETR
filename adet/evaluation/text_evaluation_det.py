...
class TextDetEvaluator(DatasetEvaluator):
    ...
    def __init__(self, dataset_name, cfg, distributed, output_dir=None):
        ...
        self.submit = False
        #/home/data3/data_wy/dept_ocr_data/data/
        # use dataset_name to decide eval_gt_path
        if "rotate" in dataset_name:
            if "totaltext" in dataset_name:
                self._text_eval_gt_path = "/home/data3/data_wy/dept_ocr_data/data//evaluation/gt_totaltext_rotate.zip"
        elif "totaltext" in dataset_name:
            self._text_eval_gt_path = "/home/data3/data_wy/dept_ocr_data/data//evaluation/gt_totaltext.zip"
        elif "ctw1500" in dataset_name:
            self._text_eval_gt_path = "/home/data3/data_wy/dept_ocr_data/data//evaluation/gt_ctw1500.zip"
        elif "art" in dataset_name:
            self._text_eval_gt_path = None
            self.submit = True
        elif "inversetext" in dataset_name:
            self._text_eval_gt_path = "/home/data3/data_wy/dept_ocr_data/data//evaluation/gt_inversetext.zip"
        else:
