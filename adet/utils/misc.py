...
def box_cxcylwlhrwrh_to_xyxy(x):
    x_c, y_c, lw, lh, rw, rh = x.unbind(-1)
    b = [(x_c - lw), (y_c - lh),
         (x_c + rw), (y_c + rh)]
...
def get_box_iou(box1, box2, eps=1e-9):
    assert (box1[:, 2:] >= box1[:, :2]).all()
    assert (box2[:, 2:] >= box2[:, :2]).all()
    #print(box1.shape)
    #px1, py1, px2, py2 = box1
    #gx1, gy1, gx2, gy2 = box2
    px1, py1, px2, py2 = box1[:, 0], box1[:, 1], box1[:, 2], box1[:, 3]
    gx1, gy1, gx2, gy2 = box2[:, 0], box2[:, 1], box2[:, 2], box2[:, 3]
