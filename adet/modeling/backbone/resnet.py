...
class ResNet(Backbone):
    ...
    def __init__(self, block_types, layers, in_chans=3,
        ...
        out_features_names = ["res3", "res4", "res5"]
        self._out_feature_strides = dict(zip(out_features_names, [8, 16, 32]))
        self._out_feature_channels = dict(
            zip(out_features_names, [x * BLOCK_TYPE[block_types[0]].expansion for x in [128, 256, 512]]))
