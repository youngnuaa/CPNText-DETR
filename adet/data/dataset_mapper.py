...
class DatasetMapperWithBasis(DatasetMapper):
    ...
    def filter_min_instances(self, instances):
    ...
    def __call__(self, dataset_dict):
        ...
        if "annotations" in dataset_dict:
            ...
            instances = annotations_to_instances(
                annos, image_shape, min_area=self.min_area, mask_format=self.instance_mask_format
            )
            ...
            dataset_dict["instances"] = utils.filter_empty_instances(instances, box_threshold=3)
            """
